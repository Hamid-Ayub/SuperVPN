...
import surf.express.nord.proton.vpn.databinding.ViewInputBinding
import surf.express.nord.proton.vpn.presentation.utils.dp2Px
import surf.express.nord.proton.vpn.presentation.utils.setFontFamilyHint
...
class InputView(context: Context?, attrs: AttributeSet?) : RelativeLayout(context, attrs),
    ...
    private fun toggleIcon() {
        ...
        binding.cbIcon.visibility =
            if (text.isEmpty() || !this.isSelected) View.INVISIBLE else View.VISIBLE
    }
